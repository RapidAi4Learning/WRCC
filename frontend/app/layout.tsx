...
// Tints the browser chrome on mobile to the college purple, matching the icon.
export const viewport: Viewport = {
  themeColor: "#582281",
};

// The icons themselves are file conventions next to this layout: icon.svg,
// favicon.ico and apple-icon.png (generated by `npm run icons`).
export const metadata: Metadata = {
  applicationName: "WRCC Social",
